define(["vector3D", "vector2D"], function(Vector3D, Vector2D){
    ...
    Light.prototype.setPosition = function(x, y, z){
        if (this.type != "spot" && this.type != "point"){ 
            throw "Error: Light object is not a point or spot light, position cannot be defined. It is a(n) " + this.type + " light.";
        }
        this.pos.set(x, y, z);
    };
    ...
    Light.prototype.setDirection = function(x, y, z){
        if (this.type != "directional" && this.type != "spot"){ 
            throw "Error: Light object is not a directional or spot light. It is a(n) " + this.type + " light.";
        }
